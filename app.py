...
from analysis import (
    ...
    target_direction, target_value_of, direction_label, best_so_far,
)
            ...
            if len(_valid_conv) > 0:
                for tv in st.session_state.target_vars:
                    ...
                    if tn in _valid_conv.columns:
                        cdata = best_so_far(_valid_conv[tn], td, t_val)
    ...
    with tab4:
        ...
        if not target_names_all:
            ...
            if t_dir == "Target":
                ...
                st.caption(f"🎯 목표 지표 **{t_name}** 를 **{t_target:g}** 에 맞추도록 탐색합니다.")
